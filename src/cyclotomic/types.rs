...
use super::params::*;
use super::sign::{
    coeffs_real_sign_2_sym, coeffs_real_sign_4_pentagonal, coeffs_real_sign_4_sym,
    coeffs_real_sign_fallback,
};
...
// NOTE: ZZ4 and ZZ12 are **not** generated by these macros. They live in
// `src/cyclotomic/rings.rs` on the new integer-basis storage. The rings
// listed here still use the legacy symbolic `GaussInt<Ratio>`-coefficient
// representation.
impl_symnum_struct_for!(8 10 16 20 24 32 60);
...
// `define_integral_zz!(name: ZZ4, ...)`.
zz_triv_impl!(HasZZ4Impl, ZZ8 ZZ16 ZZ20 ZZ24 ZZ32 ZZ60);
impl_from_int_pair!(8 16 20 24 32 60);
...
mod tests {
    ...
    // NOTE: ZZ4 and ZZ12 are excluded -- they have a non-symbolic
    ...
    zz_tests!(zz, ZZ, 8 10 16 20 24 32 60);
}
