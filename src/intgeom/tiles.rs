...
pub fn square<T: IsRingOrField + HasZZ4 + Units>() -> Snake<T> {
...
pub fn triangle<T: IsRingOrField + HasZZ6 + Units>() -> Snake<T> {
...
pub fn hexagon<T: IsRingOrField + HasZZ6 + Units>() -> Snake<T> {
...
pub fn spectre<T: IsRingOrField + HasZZ12 + Units>() -> Snake<T> {
    Snake::try_from(
...
pub fn penrose_p3_narrow<T: IsRingOrField + HasZZ10 + Units>() -> Snake<T> {
...
/// over a compatible 10-fold cyclotomic ring.
pub fn penrose_p3_wide<T: IsRingOrField + HasZZ10 + Units>() -> Snake<T> {
    // NOTE: see https://github.com/apirogov/tilezz/issues/29
    let seq: &[i8] = &[
...
pub fn tetromino_O<T: IsRingOrField + HasZZ4 + Units>() -> Snake<T> {
    Snake::try_from(upscale_angles::<T>(4, &[0, 1, 0, 1, 0, 1, 0, 1]).as_slice()).unwrap()
}

/// The straight / I-tetromino: a 1×4 strip.
#[allow(non_snake_case)]
pub fn tetromino_I<T: IsRingOrField + HasZZ4 + Units>() -> Snake<T> {
...
#[allow(non_snake_case)]
pub fn tetromino_T<T: IsRingOrField + HasZZ4 + Units>() -> Snake<T> {
...
#[allow(non_snake_case)]
pub fn tetromino_S<T: IsRingOrField + HasZZ4 + Units>() -> Snake<T> {
    Snake::try_from(upscale_angles::<T>(4, &[-1, 1, 1, 0, 1, -1, 1, 1, 0, 1]).as_slice()).unwrap()
}

/// The Z-tetromino: the mirror image of S.
#[allow(non_snake_case)]
pub fn tetromino_Z<T: IsRingOrField + HasZZ4 + Units>() -> Snake<T> {
...
#[allow(non_snake_case)]
pub fn tetromino_J<T: IsRingOrField + HasZZ4 + Units>() -> Snake<T> {
    Snake::try_from(upscale_angles::<T>(4, &[-1, 1, 1, 0, 1, 0, 0, 1, 1, 0]).as_slice()).unwrap()
}

/// The L-tetromino: the mirror image of J.
#[allow(non_snake_case)]
pub fn tetromino_L<T: IsRingOrField + HasZZ4 + Units>() -> Snake<T> {
